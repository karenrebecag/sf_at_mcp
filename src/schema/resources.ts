/** MCP schema resources — full dictionary + per-object slices. */

export const SCHEMA_RESOURCE_URI = 'schema://atfx';

export const SCHEMA_SECTION_URIS = {
  lead: 'schema://atfx/lead',
  account: 'schema://atfx/account',
  contact: 'schema://atfx/contact',
} as const;

export const SCHEMA_PREAMBLE = `# ATFX Salesforce — data dictionary (curated)
...
export const SCHEMA_LEAD = `## Lead  (418 fields; 369 custom — only the useful ones below)
...
export const SCHEMA_ACCOUNT = `## Account  (79 fields; 58 custom)
...
export const SCHEMA_CONTACT = `## Contact  (66 fields; 25 custom)
...
export const SCHEMA_PATTERNS = `## Common SOQL patterns
...
export const SCHEMA_MD = `${SCHEMA_PREAMBLE}\n${SCHEMA_LEAD}\n${SCHEMA_ACCOUNT}\n${SCHEMA_CONTACT}\n${SCHEMA_PATTERNS}`;

export const SCHEMA_RESOURCES = [
  {
    uri: SCHEMA_RESOURCE_URI,
    name: 'ATFX Salesforce data dictionary',
    description: 'Full curated schema: Lead, Account, Contact, picklists, SOQL patterns.',
    text: SCHEMA_MD,
  },
  {
    uri: SCHEMA_SECTION_URIS.lead,
    name: 'ATFX schema — Lead',
    description: 'Curated Lead fields, picklists and lifecycle semantics.',
    text: `${SCHEMA_PREAMBLE}\n${SCHEMA_LEAD}`,
  },
  {
    uri: SCHEMA_SECTION_URIS.account,
    name: 'ATFX schema — Account',
    description: 'Curated Account fields, types and funnel dates.',
    text: `${SCHEMA_PREAMBLE}\n${SCHEMA_ACCOUNT}`,
  },
  {
    uri: SCHEMA_SECTION_URIS.contact,
    name: 'ATFX schema — Contact',
    description: 'Curated Contact fields and BOS status codes.',
    text: `${SCHEMA_PREAMBLE}\n${SCHEMA_CONTACT}`,
  },
] as const;
